...
def deposit(user):
    ...
    current_balance_label = CTkLabel(deposit_screen, text = "Current Balance: $" + str(user.balance), font = ('Calibri', 12))
    ...
    #Button
    try:
        CTkButton(deposit_screen, text ="Finish", font = ('Calibri', 12), command = lambda: finish_deposit(amount, deposit_notif, current_balance_label, user)).grid(row=3, sticky = W, pady = 5)
    except FieldException as fe:
